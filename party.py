...
def is_mel(name, email):
    ...
    Expected output with Mel's email or Mel's name:

        >>> is_mel('Melany', 'mel@ubermelon.com'
        ... {'type': 'dessert'},)
        True
...
def most_and_least_common_type(treats):
    ...
    Return most and least common treat types in tuple of format (most, least).
        ...
        expected output for multiple types of food:
        ...
        expected output for only one type of food:
        ...
        expected output for a tie between the food types
